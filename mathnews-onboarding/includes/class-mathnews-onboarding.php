...
class Mathnews_Onboarding {
	 ...
	 *
	 * - Mathnews\WP\Core\Loader. Orchestrates the hooks of the plugin.
	 * - Mathnews\WP\Onboarding\i18n. Defines internationalization functionality.
	 * - Mathnews_Onboarding_Admin. Defines all hooks for the admin area.
	 *
	 ...
	 *
	 * Uses the Mathnews_Onboarding_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Admin\Mathnews_Onboarding_Admin( $this->get_plugin_name(), $this->get_version() );
